...
void mytext(int x, int y, char *string)
{
  glRasterPos2f(x, y);
  int len, i;
...
//Function which renders text
void myStrokeText(GLfloat x, GLfloat y, GLfloat sx, GLfloat sy, char str[], GLfloat width, GLubyte R, GLubyte G, GLubyte B)
{
  glRasterPos2f(x, y);
  int len, i;
  len = (int)strlen(str);glPushMatrix();
    glColor3ub(R, G, B);
    glLineWidth(width);
	glTranslatef(x, y, 0);
	glScalef(sx, sy, 0);
...
void displayInfo()
{
	//myStrokeText(x, y, sx, sy, str[], width, R, G, B);
	myStrokeText(300, 990, 0.6, 0.6, "Cambridge Institute of Technology", 4, 0, 0, 255);
	myStrokeText(440, 918, 0.3, 0.3, "Department of Computer Science & Engineering", 2.5, 0, 0, 255);
	myStrokeText(100, 774, 0.7, 0.7, "OpenGL Utility Tools And Walking Man", 4, 255, 0, 0);
	myStrokeText(780, 684, 0.3, 0.3, "VI Semester", 2.2, 0, 255, 0);
	myStrokeText(720, 630, 0.3, 0.3, "Graphics Package", 2.2, 0, 255, 0);
	myStrokeText(768, 558, 0.3, 0.3, "Submitted By", 2.2, 255, 255, 0);
	myStrokeText(442, 486, 0.3, 0.3, "1CD13CS001", 2.5, 255, 255, 0);
	myStrokeText(1152, 489, 0.3, 0.3, "Abhishek.M", 2.5, 255, 255, 0);
    myStrokeText(442, 414, 0.3, 0.3, "1CD14CS091", 2.5, 255, 255, 0);
	myStrokeText(1152, 414, 0.3, 0.3, "Manjunath.S.S", 2.5, 255, 255, 0);
	myStrokeText(600, 342, 0.3, 0.3, "for the academic year 2017", 2.0, 255, 0, 255);
    myStrokeText(670, 261, 0.3, 0.3, "Under the Guidance of", 2.2, 0, 255, 255);
	myStrokeText(650, 180, 0.3, 0.3, "Prof. Sonia Maria D'Souza", 2.5, 0, 255, 255);
	myStrokeText(800, 108, 0.3, 0.3, "Prof. Ganesh", 2.5, 0, 255, 255);
	myStrokeText(700, 36, 0.25, 0.25, "(Press any key to continue)", 2, 255, 0, 0);
}
...
void displayInstructions()
{
    ...
    mytext(200,550,"\" Left Click \" to print current cursor coordinates on terminal");
    mytext(100,450,"Press \"3\" to switch to Color Palette");
    mytext(200,400,"Click on the desired color(s) to get their RGB values");
    mytext(100,300,"Press \"Esc\" to exit");
}
...
void myinit(void)
{
    ...
    else if(miniproj==-1 || miniproj==0 || miniproj==3)
    {
...
void cursorfunc()
{
    ...
    mytext(7,60,"x =");
    mytext(7,30,"y =");
    mytext(44,60,char_xval);
    mytext(44,30,char_yval);
}
...
void colorpalette()
{
    ...
    glBegin(GL_POLYGON);
        ...
        glVertex2f(400,200);
    glEnd();
    mytext(150,320,code[oldcodeslno]);
    ...
    glBegin(GL_POLYGON);
        ...
        glVertex2f(400,100);
    glEnd();
    mytext(150,70,code[newcodeslno]);
}
